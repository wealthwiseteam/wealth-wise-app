...
import 'package:wealth_wise/view/widgets/public_card.dart';
...
class Home extends StatelessWidget {
  String userName;
   ...
   List<Widget> cards = 
   [
    PublicCard(imageUrl: AppAssets.transaction, text: 'Transactions'),
      PublicCard(imageUrl: AppAssets.goals, text: 'Goals'),
      PublicCard(imageUrl: AppAssets.bills, text: 'Bills'),
     PublicCard(imageUrl: AppAssets.budgets, text: 'Budgets'),
      PublicCard(imageUrl: AppAssets.financialTips, text: 'Financial tips'),
   ];
  @override
                        ...
                        children: [
                          ...
                          const Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Spacer(flex: 1,),
                                PublicText(txt: 'Payment Card',color: Colors.white,size: 15,fw: FontWeight.w500,),
                                Spacer(flex: 2,),
                                // دة مش هيبقي const
